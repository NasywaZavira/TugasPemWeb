...
const navbarHTML = `
  <nav style="position:fixed;top:0;left:0;width:100%;background:black;z-index:1000;padding:20px 0;display:flex;justify-content:space-between;align-items:center;">
    ...
    <li style="margin:10px 0;"><a href="index.html/#projects" style="color:#ff1b1b;text-decoration:none;">Projects</a></li>
    <li style="margin:10px 0;"><a href="index.html/#contact" style="color:#ff1b1b;text-decoration:none;">Contact</a></li>
